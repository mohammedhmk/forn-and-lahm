...
export const metadata: Metadata = {
  ...
  title: "فرن ولحم | خصم 25% على الفطاير والبيتزا – حي الصحافة، الرياض",
  description: "خصم 25% على الفطاير والبيتزا لمدة 3 أيام فقط. لحم نعيمي وفطائر طازجة، جذور في التراث، مصنوعة بشغف — فرن ولحم، حي الصحافة، الرياض.",
  openGraph: {
    title: "فرن ولحم | خصم 25% على الفطاير والبيتزا",
    description: "لمدة 3 أيام فقط — فرن ولحم، حي الصحافة، الرياض.",
